...
export default function Workspace() {
  ...
  useEffect(() => {
    ...
    setFolders((prev) => {
      const base = [{ _id: "all", name: "All Projects" }];
      const incoming = Array.isArray(foldData.folders) ? foldData.folders : [];
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <img src="/Logo/Logo.png" alt="Logo" width={28} height={28} style={{ borderRadius: 6 }} />
                ...
                >
                  {p.thumbnail ? (
                    ...
                    <div
                      style={{
                        height: 160,
                        backgroundImage: `url("/empty_canvas.png")`,
            ...
            >
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  try {
                    await fetch(`/api/folders/${selectedFolderId}/projects`, {
                      method: "PUT",
                      headers: {
                        "Content-Type": "application/json",
                        Authorization: `Bearer ${token}`,
                      ...
                      body: JSON.stringify({
                        projectId: selectedProjectToAdd._id,
                        action: "add",
                      }),
                    });
